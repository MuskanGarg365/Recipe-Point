...
import getRecipe from "@salesforce/apex/CallouttoSpoonacular.getRecipeInformation";
import SystemModstamp from '@salesforce/schema/Account.SystemModstamp';

export default class GetRecipeInfo extends LightningElement {
    ...
    @api
    fetchRecipe() {
        console.log('Hit recipe info button');
    ...
    get hasDetails() {
        console.log('Recahed full and no details method');
